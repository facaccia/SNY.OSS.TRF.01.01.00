...
// Back end, inizializziamo una variabile cont, cioè quanto istanze deve creare per il  la mia macchina di be
...
// è cambiata la lista delle macchine sul be ? se si esegui un operazione
