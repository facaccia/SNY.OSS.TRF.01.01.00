module "vpc" {
  ...
  VPC_NAME = "fabio"
  // se scrivi una variable vuol dire che la stai sovrascrivendo, nel caso tu voglia prendere quella di default fai direttamente che non inizializzarla.
...
module "frontend" {
  ...
  INSTANCE_NAME = "fabio-fe-loadbalancer"
